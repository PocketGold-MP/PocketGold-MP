...
class MakeServerCommand extends VanillaCommand{
	...
	public function __construct(string $name){
		parent::__construct($name, "Erstelle eine phar", "/makeserver", ["ms"]);
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		$pharPath = "PocketGold" . DIRECTORY_SEPARATOR . $server->getName() . "_v" . $server->getApiVersion() . ".phar";
		...
		$phar->setStub('<?php require_once("phar://". __FILE__ ."/src/pocketmine/PocketGold.php");  __HALT_COMPILER();');

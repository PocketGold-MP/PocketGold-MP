...
use pocketmine\command\defaults\MuteCommand;
use pocketmine\command\defaults\UnmuteCommand;
...
class SimpleCommandMap implements CommandMap{
	...
	private function setDefaultCommands(){
		...
		if($this->server->getPocketGoldProperty("developer.commands", true)){
			$this->registerAll("pocketgold", [

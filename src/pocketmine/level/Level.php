...
class Level implements ChunkManager, Metadatable{
	...
	protected function actuallyDoTick(int $currentTick) : void{
		...
		if($this->server->getPocketGoldProperty("level.generic-auto-mob-spawning", false) and $this->gameRules->getBool(GameRules::RULE_DO_MOB_SPAWNING) and $currentTick % 400 === 0){
			$eligibleChunks = [];
